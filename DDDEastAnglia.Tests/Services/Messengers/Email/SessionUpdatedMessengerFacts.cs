...
{
    [TestFixture]
    public class SessionUpdatedMailMessengerFacts
    {
        [TestFixture]
        public class Notify_Should
        {
            ...
            public void Prepare_The_Mail_For_Delivery()
            {
                ...
                var messenger = new SessionUpdatedMailMessenger(postman, template);
                ...
                var message = new MailMessage
                {
                    ...
                    Subject = "DDD East Anglia Updated Session: My awesome session",
                    Body = "Message body"
                };
